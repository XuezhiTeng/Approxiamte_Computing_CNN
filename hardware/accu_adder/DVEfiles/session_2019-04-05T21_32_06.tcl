...
# DVE full session
# Saved on Fri Apr 5 21:32:06 2019
# Designs open: 1
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 275} {height 422} {dock_state left} {dock_on_new_line true} {child_hier_colhier 253} {child_hier_coltype 54} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 291} {height 422} {dock_state left} {dock_on_new_line true} {child_data_colvariable 209} {child_data_colvalue 47} {child_data_coltype 67} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_sch_show -window ${Schematic.1} -name TOP.csa
gui_show_pin_value_annotate [gui_window_hier_name -window ${Schematic.1}]
gui_zoom -window ${Schematic.1} -rect { {-1328 -54431} {206131 26625} }
