...
# DVE full session
# Saved on Tue Nov 27 22:01:34 2018
# Designs open: 1
...
#<Session mode="Full" path="/home/ecelrc/students/xteng/vlsi1/lab3/rtl/DVEfiles//crash_11.27-22.01/dve_session11.27-22.01.tcl" type="Debug">
...
gui_sg_addsignal -group "$_session_group_1" { TOP.ARM.dataBus TOP.ARM.addressBus }
...
catch { gui_list_select -id ${Data.1} {TOP.ARM.dataBus TOP.ARM.addressBus }}
