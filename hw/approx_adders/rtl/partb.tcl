...
# DVE full session
# Saved on Tue Nov 27 23:00:51 2018
# Designs open: 1
#   Sim: simv
...
#<Session mode="Full" path="/home/ecelrc/students/xteng/vlsi1/lab3/rtl/partb.tcl" type="Debug">
...
gui_update_layout -id ${Wave.1} {{show_state maximized} {dock_state undocked} {dock_on_new_line false} {child_wave_left 445} {child_wave_right 1085} {child_wave_colname 219} {child_wave_colvalue 221} {child_wave_col1 0} {child_wave_col2 1}}
...
gui_sim_run Ucli -exe simv -args {-ucligui } -dir ../rtl -nosource
}
}
...
gui_sg_addsignal -group "$_session_group_29" { TOP.R0_U TOP.R1_U TOP.R2_U TOP.R3_U TOP.R4_U TOP.R5_U TOP.R6_U TOP.addbusam TOP.MASTER.rst_i TOP.MASTER.clk_i TOP.MASTER.mem_req TOP.MASTER.memoryRead TOP.MASTER.memoryWrite TOP.MASTER.ack_i TOP.MASTER.addressBus TOP.MASTER.dat_i TOP.MASTER.adr_o TOP.MASTER.dat_o TOP.MASTER.we_o TOP.MASTER.stb_o TOP.MASTER.cyc_o TOP.MASTER.dataBus TOP.MASTER.taga_o TOP.MASTER.state TOP.MASTER.next_state }

set _session_group_30 SLAVE
gui_sg_create "$_session_group_30"
set SLAVE "$_session_group_30"

gui_sg_addsignal -group "$_session_group_30" { TOP.SLAVE.dat_i TOP.SLAVE.cyc_i TOP.SLAVE.dat_o TOP.SLAVE.we_i TOP.SLAVE.adr_i TOP.SLAVE.stb_i TOP.SLAVE.ack_o TOP.SLAVE.ssp_w_o TOP.SLAVE.ssp_sel_o TOP.SLAVE.mem_w_o TOP.SLAVE.next_state TOP.SLAVE.mem_adr_o TOP.SLAVE.state TOP.SLAVE.rst_i TOP.SLAVE.dataBus TOP.SLAVE.taga_i TOP.SLAVE.mem_r_o TOP.SLAVE.clk_i TOP.databusam }

set _session_group_31 Group2
gui_sg_create "$_session_group_31"
set Group2 "$_session_group_31"

gui_sg_addsignal -group "$_session_group_31" { TOP.MASTER.dat_i TOP.MASTER.dat_o TOP.MASTER.memoryRead TOP.MASTER.cyc_o TOP.MASTER.ack_i TOP.MASTER.we_o TOP.MASTER.adr_o TOP.MASTER.stb_o TOP.MASTER.memoryWrite TOP.MASTER.next_state TOP.MASTER.state TOP.MASTER.rst_i TOP.MASTER.mem_req TOP.MASTER.dataBus TOP.MASTER.taga_o TOP.MASTER.clk_i TOP.MASTER.addressBus }

set _session_group_32 Group3
gui_sg_create "$_session_group_32"
set Group3 "$_session_group_32"

gui_sg_addsignal -group "$_session_group_32" { TOP.R6_U TOP.R0_U TOP.R1_U TOP.R2_U TOP.R3_U TOP.R4_U TOP.R5_U }

set _session_group_33 Group4
gui_sg_create "$_session_group_33"
set Group4 "$_session_group_33"

gui_sg_addsignal -group "$_session_group_33" { TOP.CMU.phi1 TOP.CMU.phi2 }

set _session_group_34 ARM
gui_sg_create "$_session_group_34"
set ARM "$_session_group_34"

gui_sg_addsignal -group "$_session_group_34" { TOP.ARM.dataBus TOP.ARM.addressBus TOP.ARM.phi1 TOP.ARM.phi2 TOP.ARM.clear TOP.ARM.test TOP.ARM.scanin TOP.ARM.scanout TOP.ARM.en_buses_bar TOP.ARM.mem_req_bar TOP.ARM.mem_write_read TOP.ARM.mem_word_byte TOP.ARM.mode_bar TOP.ARM.memoryWrite TOP.ARM.memoryRead }

set _session_group_35 slave
gui_sg_create "$_session_group_35"
set slave "$_session_group_35"

gui_sg_addsignal -group "$_session_group_35" { TOP.SLAVE.dat_i TOP.SLAVE.cyc_i TOP.SLAVE.dat_o TOP.SLAVE.we_i TOP.SLAVE.adr_i TOP.SLAVE.stb_i TOP.SLAVE.ack_o TOP.SLAVE.ssp_w_o TOP.SLAVE.ssp_sel_o TOP.SLAVE.mem_w_o TOP.SLAVE.next_state TOP.SLAVE.mem_adr_o TOP.SLAVE.rst_i TOP.SLAVE.state TOP.SLAVE.taga_i TOP.SLAVE.dataBus TOP.SLAVE.mem_r_o TOP.SLAVE.clk_i }

set _session_group_36 master
gui_sg_create "$_session_group_36"
set master "$_session_group_36"

gui_sg_addsignal -group "$_session_group_36" { TOP.MASTER.dat_i TOP.MASTER.dat_o TOP.MASTER.memoryRead TOP.MASTER.cyc_o TOP.MASTER.ack_i TOP.MASTER.we_o TOP.MASTER.adr_o TOP.MASTER.stb_o TOP.MASTER.memoryWrite TOP.MASTER.next_state TOP.MASTER.state TOP.MASTER.rst_i TOP.MASTER.mem_req TOP.MASTER.dataBus TOP.MASTER.taga_o TOP.MASTER.clk_i TOP.MASTER.addressBus }

set _session_group_37 arm_memory
gui_sg_create "$_session_group_37"
set arm_memory "$_session_group_37"

gui_sg_addsignal -group "$_session_group_37" { TOP.databusam TOP.R6_U TOP.R0_U TOP.R1_U TOP.R2_U TOP.R3_U TOP.R4_U TOP.R5_U }

set _session_group_38 txfifo
gui_sg_create "$_session_group_38"
set txfifo "$_session_group_38"

gui_sg_addsignal -group "$_session_group_38" { TOP.ssp.TxFIFO_tester.PSEL TOP.ssp.TxFIFO_tester.PWRITE TOP.ssp.TxFIFO_tester.CLEAR_B TOP.ssp.TxFIFO_tester.PCLK TOP.ssp.TxFIFO_tester.SENT TOP.ssp.TxFIFO_tester.PWDATA TOP.ssp.TxFIFO_tester.TxDATA TOP.ssp.TxFIFO_tester.SSPTXINTR TOP.ssp.TxFIFO_tester.VALID TOP.ssp.TxFIFO_tester.full TOP.ssp.TxFIFO_tester.empty TOP.ssp.TxFIFO_tester.wre TOP.ssp.TxFIFO_tester.rde TOP.ssp.TxFIFO_tester.wp TOP.ssp.TxFIFO_tester.rp TOP.ssp.TxFIFO_tester.mcell0 TOP.ssp.TxFIFO_tester.mcell1 TOP.ssp.TxFIFO_tester.mcell2 TOP.ssp.TxFIFO_tester.mcell3 TOP.ssp.TxFIFO_tester.flag0 TOP.ssp.TxFIFO_tester.flag1 TOP.ssp.TxFIFO_tester.flag2 TOP.ssp.TxFIFO_tester.flag3 }
...
gui_open_source -id ${Source.1}  -replace -active TOP.ssp SSP.v
...
gui_wv_zoom_timerange -id ${Wave.1} 0 14589
...
gui_list_add_group -id ${Wave.1} -after {New Group} {arm_memory}
gui_list_add_group -id ${Wave.1} -after {New Group} {txfifo}
gui_list_select -id ${Wave.1} {TOP.ssp.TxFIFO_tester.TxDATA }
...
gui_list_set_insertion_bar  -id ${Wave.1} -group txfifo  -position in

gui_marker_move -id ${Wave.1} {C1} 3540
gui_view_scroll -id ${Wave.1} -vertical -set 1348
