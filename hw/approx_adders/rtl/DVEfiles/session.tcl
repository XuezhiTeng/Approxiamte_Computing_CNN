...
# DVE full session
# Saved on Fri Nov 30 15:18:30 2018
# Designs open: 1
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 127} {height 535} {dock_state left} {dock_on_new_line true} {child_hier_colhier 140} {child_hier_coltype 100} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 205} {height 535} {dock_state left} {dock_on_new_line true} {child_data_colvariable 140} {child_data_colvalue 100} {child_data_coltype 40} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_update_layout -id ${Console.1} {{left 0} {top 0} {width 1535} {height 170} {dock_state bottom} {dock_on_new_line true}}
...
set _session_group_16 R0-R6
gui_sg_create "$_session_group_16"
set R0-R6 "$_session_group_16"

gui_sg_addsignal -group "$_session_group_16" { TOP.R0_U TOP.R1_U TOP.R2_U TOP.R3_U TOP.R4_U TOP.R5_U TOP.R6_U }

set _session_group_17 master
gui_sg_create "$_session_group_17"
set master "$_session_group_17"

gui_sg_addsignal -group "$_session_group_17" { TOP.MASTER.rst_i TOP.MASTER.clk_i TOP.MASTER.mem_req TOP.MASTER.memoryRead TOP.MASTER.memoryWrite TOP.MASTER.ack_i TOP.MASTER.addressBus TOP.MASTER.dat_i TOP.MASTER.adr_o TOP.MASTER.dat_o TOP.MASTER.we_o TOP.MASTER.stb_o TOP.MASTER.cyc_o TOP.MASTER.dataBus TOP.MASTER.taga_o TOP.MASTER.state TOP.MASTER.next_state TOP.MASTER.dat_i_temp }
...
set _session_group_19 txfifo
gui_sg_create "$_session_group_19"
set txfifo "$_session_group_19"

gui_sg_addsignal -group "$_session_group_19" { TOP.ssp.TxFIFO_tester.PSEL TOP.ssp.TxFIFO_tester.PWRITE TOP.ssp.TxFIFO_tester.CLEAR_B TOP.ssp.TxFIFO_tester.PCLK TOP.ssp.TxFIFO_tester.SENT TOP.ssp.TxFIFO_tester.PWDATA TOP.ssp.TxFIFO_tester.TxDATA TOP.ssp.TxFIFO_tester.SSPTXINTR TOP.ssp.TxFIFO_tester.VALID TOP.ssp.TxFIFO_tester.full TOP.ssp.TxFIFO_tester.empty TOP.ssp.TxFIFO_tester.wre TOP.ssp.TxFIFO_tester.rde TOP.ssp.TxFIFO_tester.wp TOP.ssp.TxFIFO_tester.rp TOP.ssp.TxFIFO_tester.mcell0 TOP.ssp.TxFIFO_tester.mcell1 TOP.ssp.TxFIFO_tester.mcell2 TOP.ssp.TxFIFO_tester.mcell3 TOP.ssp.TxFIFO_tester.flag0 TOP.ssp.TxFIFO_tester.flag1 TOP.ssp.TxFIFO_tester.flag2 TOP.ssp.TxFIFO_tester.flag3 }

set _session_group_20 cmu
gui_sg_create "$_session_group_20"
set cmu "$_session_group_20"

gui_sg_addsignal -group "$_session_group_20" { TOP.CMU.clk_i TOP.CMU.clear_i TOP.CMU.ssp_intr_i TOP.CMU.phi1 TOP.CMU.phi2 TOP.CMU.clk_o TOP.CMU.clear_o TOP.CMU.cnt }
